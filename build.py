...
--m-bg:#eef1f5;--m-fg:#4a5768;--w-bg:#e9f0e7;--w-fg:#4a6b45;--v-bg:#fbe9ef;--v-fg:#9c3f60;--e-bg:#e6eff1;--e-fg:#3d6470;--b-bg:#f3ecfb;--b-fg:#6b4a92;--link:#1a56cc}
...
--v-bg:#3a222c;--v-fg:#eaa2bc;--e-bg:#1e2c31;--e-fg:#93c0cc;--b-bg:#2b2338;--b-fg:#c4a9e8;--link:#7ab7ff}}
...
--v-bg:#fbe9ef;--v-fg:#9c3f60;--e-bg:#e6eff1;--e-fg:#3d6470;--b-bg:#f3ecfb;--b-fg:#6b4a92;--link:#1a56cc}
